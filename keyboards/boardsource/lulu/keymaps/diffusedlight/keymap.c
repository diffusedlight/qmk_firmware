...
[_NUM] = LAYOUT(
  ...
  XXXXXXX, KC_AMPR,    KC_4,    KC_5,    KC_6,  KC_EQL,                   XXXXXXX, _______, _______, _______, _______, _______,
...
[_SYMBOL] = LAYOUT(
  ...
  XXXXXXX,  KC_DLR, KC_EXLM,  KC_LPRN, KC_RPRN, KC_PLUS,                    XXXXXXX, _______, _______, _______, _______, _______,
 ...
 */
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    KC_DEL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  _______, _______, _______, _______, _______, XXXXXXX,                      KC_H,    KC_J,    KC_K,    KC_L, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CW_TOGG, KC_HOME,  KC_INS, XXXXXXX,  KC_END, XXXXXXX, XXXXXXX,
 ...
 */
  ...
  _______, _______, _______, _______, _______, XXXXXXX,                   KC_PSCR, KC_MPRV, KC_MPLY, KC_MSTP, KC_MNXT, XXXXXXX,
 ...
 */
  ...
  XXXXXXX, KC_F11, KC_F4, KC_F5, KC_F6, XXXXXXX,                   XXXXXXX, _______, _______, _______, _______, _______,
